...
public static class PartsManager
{
    ...
    static readonly string BaseAddress = "http://mslearnpartsserver161778733.azurewebsites.net";
    ...
    private static async Task<HttpClient> GetClient()
    {
        ...
        client.DefaultRequestHeaders.Add("Autorizacion", authorizationKey);
        client.DefaultRequestHeaders.Add("Aceptar", "application/json");
